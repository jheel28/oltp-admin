...
const EditQuestionPaper = ({ questionPaper, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/beta/questionpaper/update/questionpaper/superadmin/byid/${editedQuestionPaper._id}`,
        {
          method: "PATCH",
          headers: {
      ...
      for (const question of questions) {
        ...
        const url = isNew
          ...
          : `${process.env.REACT_APP_BACKEND_URL}/api/beta/question/update/question/superadmin/byid/${question._id}`;
      ...
      message.success("Question Paper and Questions successfully updated (SuperAdmin)");
      setTimeout(() => {
