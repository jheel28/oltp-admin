        ...
        >
          ...
          <div className="mb-2">
            ...
            <div className="mt-2 text-sm">
              ...
              <select
                className="block w-full rounded-lg border-gray-300 p-2 mt-1 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-navy-700"
                value={question.type}
                onChange={(e) => {
